  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {products.map((product, index) => (
        <div
          key={index}
          className="glass-card rounded-2xl p-8 transition-all duration-500 group relative overflow-hidden animate-fade-in"
        ...
        >
          ...
          <div className="relative z-10">
            <div className="mb-6">
              <div className="w-16 h-16 glass-card rounded-2xl flex items-center justify-center mb-6 transition-transform duration-300 group-hover:shadow-neon">
